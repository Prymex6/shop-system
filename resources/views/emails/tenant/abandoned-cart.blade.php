...
<head>
  ...
  <title>Zapomniałeś czegoś w koszyku?</title>
</head>
@php
        ...
        <table width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;">
          ...
          <tr>
            <td align="center" style="padding:0 0 24px 0;">
              ...
              <p style="margin:0;font-size:13px;color:#6b7280;">Twój koszyk czeka</p>
            </td>
          </tr>
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center" style="background:{{ $primaryColor }};padding:28px 32px;">
                    <p style="margin:0 0 6px 0;font-size:20px;font-weight:700;color:#ffffff;">Zapomniałeś czegoś? 🛒</p>
                    <p style="margin:0;font-size:13px;color:#ffffff;opacity:.85;">Produkty w Twoim koszyku czekają na Ciebie!</p>
                  </td>
                </tr>
              </table>
                ...
                <tr>
                  <td style="padding:32px;">
                    ...
                    <p style="margin:0 0 16px 0;font-size:14px;color:#6b7280;line-height:1.7;">
                      Zauważyliśmy, że masz produkty w koszyku. Wróć i dokończ swoje zakupy, zanim ktoś inny zajmie ostatnie sztuki!
                    </p>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:20px;font-size:14px;border-collapse:collapse;">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td style="padding:10px;border-bottom:1px solid #f3f4f6;text-align:right;">{{ number_format(($item['price'] ?? 0) * ($item['quantity'] ?? 1), 2, ',', ' ') }} zł</td>
                        </tr>
                        @endforeach
                      </tbody>
                    </table>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
                      <tr>
                        <td>
                          <a href="{{ $cartUrl }}" style="display:inline-block;background:{{ $primaryColor }};color:#ffffff;text-decoration:none;padding:13px 28px;border-radius:7px;font-weight:700;font-size:15px;">Dokończ zakupy</a>
                        </td>
                      </tr>
                    </table>

                    <p style="margin:0;font-size:13px;color:#9ca3af;">
                      Jeśli nie chcesz więcej otrzymywać takich przypomnień, możesz to zignorować.
                    </p>
          ...
          <tr>
            <td align="center" style="padding:24px 0 0 0;font-size:12px;color:#9ca3af;line-height:1.6;">
              &copy; {{ date('Y') }} {{ $shopName }} &middot; Nie możesz? Kup później!
            </td>
          </tr>
