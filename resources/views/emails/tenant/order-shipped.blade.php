              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center" style="background:{{ $primaryColor }};padding:28px 32px;">
                    ...
                    <p style="margin:0 0 6px 0;font-size:20px;font-weight:700;color:#ffffff;">Twoje zamówienie jest w drodze!</p>
                ...
                <tr>
                  <td style="padding:32px;">
                    ...
                    <p style="margin:0 0 24px 0;font-size:14px;color:#6b7280;line-height:1.7;">
                      Twoje zamówienie zostało przekazane do dostawy. Możesz śledzić jego status poniżej.
                    </p>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
                      <tr>
                        <td style="background:#f9fafb;border:1px solid #e5e7eb;border-radius:8px;padding:16px;font-size:14px;line-height:1.8;color:#374151;">
                          ...
                          <strong>Przewoźnik:</strong> {{ $order->tracking_carrier }}<br>
                          @endif
                          <strong>Numer śledzenia:</strong>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:20px;">
                      <tr>
                        <td>
                          <a href="{{ $trackingUrl }}" style="display:inline-block;background:{{ $primaryColor }};color:#ffffff;text-decoration:none;padding:13px 28px;border-radius:7px;font-weight:700;font-size:15px;">Śledź zamówienie</a>
                        </td>
                      </tr>
                    </table>
