        ...
        <table width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;">
          ...
          <tr>
            <td align="center" style="padding:0 0 24px 0;">
              ...
              <p style="margin:0;font-size:13px;color:#6b7280;">Wiadomość od sklepu</p>
            </td>
          </tr>
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="padding:28px 32px;font-size:15px;line-height:1.7;color:#374151;">
                    <p style="margin:0 0 16px 0;">Cześć@if($recipientName), <strong>{{ $recipientName }}</strong>@endif!</p>
          ...
          <tr>
            <td align="center" style="padding:24px 0 0 0;font-size:12px;color:#9ca3af;line-height:1.6;">
              ...
              <p style="margin:0;font-size:11px;">
                <a href="{{ $unsubscribeUrl }}" style="color:#9ca3af;text-decoration:underline;">Wypisz się z listy mailingowej</a>
              </p>
            </td>
          </tr>
